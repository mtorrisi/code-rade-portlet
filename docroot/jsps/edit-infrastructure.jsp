...
<%
	...
	int id = ParamUtil.getInteger(renderRequest, "id", -1);
	int infraNumber = 0;
...
<portlet:actionURL name="editInfrastructure" var="editInfrastructureURL" />
...
<center>
	<aui:form action="<%=editInfrastructureURL%>" method="post">
		<table class="table_prefs">
			...
			<tr>
				<td class="label_prefs"/>
				<td ><liferay-ui:error key="empty-infra-name"
					message="empty-infra-name" /></td>
			</tr>
			<tr>
				...
				<td><aui:input type="text"
						...
						value="<%= infrastructureInfo.getNameInfrastructure() %>" label="" />
					</td>
			</tr>
			<tr>
				<td class="label_prefs"/>
				<td ><liferay-ui:error key="empty-infra-acronym"
					message="empty-infra-acronym" /></td>
			</tr>
			<tr>
			...
			<tr>
				<td class="label_prefs"><b>Proxy Robot Renewal Flag </b></td>
				<td> 
			...
			<tr>
				<td class="label_prefs"><b>Local Proxy</b></td>
				<td><aui:input type="text"
					style="width: 98%"
				...
				<tr>
				<td class="label_prefs"><b>Software	Tags </b></td>
				<td><aui:input type="text"
					style="width: 98%"
